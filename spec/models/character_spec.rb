...
RSpec.describe Character, type: :model do
  ...
  context 'when testing validations' do
    ...
    it { is_expected.to validate_numericality_of(:health_points).is_greater_than_or_equal_to(80).is_less_than_or_equal_to(100) }
    it { is_expected.to validate_numericality_of(:attack_damage).is_greater_than_or_equal_to(10).is_less_than_or_equal_to(20) }
  end
